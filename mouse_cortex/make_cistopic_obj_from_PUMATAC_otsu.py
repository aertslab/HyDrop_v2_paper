...
print('set up paths.......')
proj_dir = ""
outdir = "/staging/leuven/stg_00002/lcb/hydrop_v2_paper/mcortex/cistopic/mcortex_all_otsu_notdownsampled_own_consensuspeaks"
tmp_dir = '/scratch/leuven/350/vsc35050/mcortex/'
...
consensus_peaks_path = '/lustre1/project/stg_00002/lcb/hdickm/resources/mouse/consensus_regions_mouse_atlas_notdownsampled_chosensamples_072024.bed' #updated own consensus regions
path_to_blacklist ='/staging/leuven/stg_00002/lcb/hdickm/resources/mouse/mm10-blacklist.v2.bed'
...
fragments_dict_subset = {
    ...
    for x in sorted(
        sorted(
            glob.glob(            "/lustre1/project/stg_00002/lcb/hydrop_v2_paper/mcortex/cistopic/mcortex_all_otsu_notdownsampled/fragments/*.fragments.tsv.gz" #should be all, copied into own folder bc of problems with permissions
            )
        )
    )
}
...
#            ] = f"/staging/leuven/stg_00090/ASA/analysis/analysis_Olga/0_cingulate_cortex_trials/20230531_ATAC_QC_2/selected_barcodes/{sample}_bc_passing_filters.pkl"
            metadata_bc_sub_dict[sample] = f"/lustre1/project/stg_00002/lcb/fderop/data/20231115_hydrop_v2/analysis_mouse/cistopic_qc_out/{sample}__metadata_bc.pkl" #correct
            bc_passing_filters_sub_dict[sample] = f"/lustre1/project/stg_00002/lcb/fderop/data/20231115_hydrop_v2/analysis_mouse/selected_barcodes/{sample}_bc_passing_filters_otsu.pkl" #correct
print()
print('samples: ')
